...
namespace GAP.Repository.Cidi.CidiUtil
{
    public class Config
    {
        ...
        {
            byte[] buffer = Encoding.ASCII.GetBytes(TimeStamp + GlobalVars.CiDiKeyAplicacion);
    ...
    public class APICuenta
    {
        public class Usuario
        {
            ...
            public static String Obtener_Usuario_Aplicacion
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Usuario/Obtener_Usuario_Aplicacion";
                }
            }
            ...
            public static String Obtener_Usuario
            {
                get
                {
                    return GlobalVars.APICuenta+ "api/Usuario/Obtener_Usuario";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Usuario/Obtener_Usuario_Basicos";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos_CUIL
            {
                get
                {
                    return GlobalVars.APICuenta+ "api/Usuario/Obtener_Usuario_Basicos_CUIL";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos_Domicilio
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Usuario/Obtener_Usuario_Basicos_Domicilio";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos_Domicilio_CUIL
            {
                get
                {
                    return GlobalVars.APICuenta+ "api/Usuario/Obtener_Usuario_Basicos_Domicilio_CUIL";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos_Representado
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Usuario/Obtener_Usuario_Basicos_Representado";
                }
            }
            ...
            public static String Obtener_Representado
            {
                get
                {
                    return GlobalVars.APICuenta+ "api/Usuario/Obtener_Representado";
                }
            }
            ...
            public static String Cerrar_Sesion_Usuario_Aplicacion
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Usuario/Cerrar_Sesion_Usuario_Aplicacion"; 
                }
            }
        }
        ...
        public class Representado
        {
            ...
            public static String Obtener_Usuario_Y_Representados
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Obtener_Usuario_Y_Representados";
                }
            }
            ...
            public static String Obtener_Usuario_Lista_Representados
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Obtener_Usuario_Lista_Representados";
                }
            }
            ...
            public static String Obtener_Representado_Lista_Representantes
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Obtener_Representado_Lista_Representantes";
                }
            }
            ...
            public static String Obtener_Usuario_Basicos_Representado
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Obtener_Usuario_Basicos_Representado";
                }
            }
            ...
            public static String Obtener_Representado
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Obtener_Representado";
                }
            }
        }
        ...
        public class Aplicacion
        {
            ...
            public static String Cambiar_Contrasenia_Aplicacion
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Cambiar_Contrasenia_Aplicacion";
                }
            }
            ...
            public static String Registrar_Aplicacion
            {
                get
                {
                    return GlobalVars.APICuenta + "api/Representado/Registrar_Aplicacion";
                }
            }
        }
    }
    ...
    public class APIComunicacion
    {
        public class Notificacion
        {
            ...
            public static String Enviar_Alerta
            {
                get
                {
                    return GlobalVars.APIComunicacion + "api/Notificacion/Enviar_Alerta";
                }
            }
        }
        ...
        public class SMS
        {
            ...
            public static String Enviar
            {
                get
                {
                    return GlobalVars.APIComunicacion + "api/SMS/Enviar";
                }
            }
            ...
            public static String Enviar_Aplicacion
            {
                get
                {
                    return GlobalVars.APIComunicacion + "api/SMS/Enviar_Aplicacion";
                }
            }
        }
        ...
        public class Email
        {
            ...
            public static String Enviar
            {
                get
                {
                    return GlobalVars.APIComunicacion + "api/Email/Enviar";
                }
            }
            ...
            public static String Enviar_Aplicacion
            {
                get
                {
                    return GlobalVars.APIComunicacion + "api/Email/Enviar_Aplicacion";
                }
            }
        }
    }
    ...
    public class APIDocumentacion
    {
        public class Documentacion
        {
            ...
            public static String Obtener_Documentacion_Usuario
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Documentacion_Usuario";
                }
            }
            ...
            public static String Obtener_Documentacion_Sesion
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Documentacion_Sesion";
                }
            }
            ...
            public static String Obtener_Tipo_Documentos
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Tipo_Documentos";
                }
            }
            ...
            public static String Obtener_Vista_Previa
            {
                get
                {
                    return  GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Vista_Previa";
                }
            }
            ...
            public static String Obtener_Documento
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Documento";
                }
            }
            ...
            public static String Obtener_Foto_Perfil
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Obtener_Foto_Perfil";
                }
            }
            ...
            public static String Guardar_Documento
            {
                get
                {
                    return GlobalVars.APIDocumentacion + "api/Documentacion/Guardar_Documento";
                }
            }
        }
    }
    ...
    public class APIMobile
    {
        public class Mobile
        {
            ...
            public static String Login_Usuario
            {
                get
                {
                    return GlobalVars.APIMobile + "api/Mobile/Login_Usuario";
                }
            }
        }
    }
