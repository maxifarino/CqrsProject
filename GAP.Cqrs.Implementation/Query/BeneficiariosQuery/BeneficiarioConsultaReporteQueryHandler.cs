...
{
    public class BeneficiarioConsultaReporteQueryHandler : IQueryHandler<BeneficiarioReporteQuery, BeneficiarioConsultaReporteQueryResult>
    {
        private readonly RepositoryLocalScheme _repositryLocalScheme;

        public BeneficiarioConsultaReporteQueryHandler(RepositoryLocalScheme repository)
        {
